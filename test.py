...
def InverseKinematics(Xcor, Ycor, Zcor, y_cor, p_cor, r_cor):
    ...
    #J3 Matrix
    J_3 = RotMat(DH[2][0] - 90, DH[2][1], DH[2][2], DH[2][3])
    ...
    if DH[3][0] > 0:
        angle_J5 = atan2(sqrt(1 - (R_3_6[2][2] * R_3_6[2][2])), R_3_6[2][2])
        angle_J4 = atan2(R_3_6[1][2], R_3_6[0][2])
        angle_J6 = atan2(R_3_6[2][1], -R_3_6[2][0])
    elif DH[3][0] < 0:
        angle_J5 = atan2(- sqrt(1 - (R_3_6[2][2]*R_3_6[2][2])), R_3_6[2][2])
        angle_J4 = atan2(-R_3_6[1][2], -R_3_6[0][2])
        angle_J6 = atan2(-R_3_6[2][1], R_3_6[2][0])
    ...
    print("function run time " + str((end - start) * 1000 - 1000) + " ms")
